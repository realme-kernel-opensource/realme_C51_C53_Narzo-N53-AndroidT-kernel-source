...
#define NATIVE_INIT_COMMAND_RESTORECON_DATA_START                              \
	"NATIVE_INIT_COMMAND_RESTORECON_DATA_START"
#define NATIVE_INIT_COMMAND_RESTORECON_DATA_END                                \
	"NATIVE_INIT_COMMAND_RESTORECON_DATA_END"
#define NATIVE_INIT_POST_FS "NATIVE_INIT_POST_FS"
#define NATIVE_INIT_TRIGGER_POST_FS_DATA "NATIVE_INIT_TRIGGER_POST_FS_DATA"
#define NATIVE_INIT_TRGGIER_RESTART_FRAMEWORK                                  \
	"NATIVE_INIT_TRGGIER_RESTART_FRAMEWORK"
...
#define NATIVE_VOLD_DECRYPT_MASTER_KEY_START                                   \
	"NATIVE_VOLD_DECRYPT_MASTER_KEY_START"
...
#define NATIVE_VOLD_CRYPTFS_RESTART_INTERNAL_START                             \
	"NATIVE_VOLD_CRYPTFS_RESTART_INTERNAL_START"
#define NATIVE_VOLD_CRYPTFS_RESTART_INTERNAL_END                               \
	"NATIVE_VOLD_CRYPTFS_RESTART_INTERNAL_END"
...
#define ANDROID_PMS_DEXOPT_PERSISTPKGS_START                                   \
...
#define ERROR_CRITICAL_SERVICE_CRASHED_4_TIMES                                 \
...
#define PHX_KLOG_ERROR(fmt, args...)                                           \
	do {                                                                   \
		printk(KERN_ERR "[PHOENIX] %s: " fmt, __func__, ##args);       \
	} while (0)
#define PHX_KLOG_INFO(fmt, args...)                                            \
	do {                                                                   \
		printk(KERN_INFO "[PHOENIX] %s: " fmt, __func__, ##args);      \
	} while (0)
