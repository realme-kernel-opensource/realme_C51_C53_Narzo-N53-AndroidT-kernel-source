...
bool ufshpb_is_hpb_enabled(struct ufs_hba *hba) {return 0; }
bool *ufshpb_hpb_enabled(struct ufs_hba *hba) {return 0; }
...
void ufshcd_hpb_add_command_trace(struct ufs_hba *hba, unsigned int tag, const char *str) {}
#else
