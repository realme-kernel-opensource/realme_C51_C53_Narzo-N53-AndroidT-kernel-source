...
#define REG06_BQ25910_PRECHARGE_THRESHOLD_2600MV				0
#define REG06_BQ25910_PRECHARGE_THRESHOLD_2900MV				BIT(0)//default
#define REG06_BQ25910_PRECHARGE_THRESHOLD_3200MV				BIT(1)
#define REG06_BQ25910_PRECHARGE_THRESHOLD_3500MV				(BIT(1) | BIT(0))

/* Address:07h */
#define REG07_BQ25910_ADDRESS										0x07
#define REG07_BQ25910_PG_STAT_MASK								(BIT(7))
#define REG07_BQ25910_PG_STAT_GOOD								(BIT(7))
