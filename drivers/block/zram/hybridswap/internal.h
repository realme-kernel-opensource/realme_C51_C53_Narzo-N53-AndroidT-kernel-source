...
typedef struct mem_cg_oem_data {
    u32 id;
	u64 android_oem_data1;
}mem_cg_oem_data_t;

extern mem_cg_oem_data_t hyb_oem_data[];

#define MEMCGRP_ITEM_DATA(memcg) ((memcg_hybs_t *)hyb_oem_data[memcg->id.id].android_oem_data1)
