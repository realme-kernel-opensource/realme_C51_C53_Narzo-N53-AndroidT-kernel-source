...
static unsigned int emmc_manfid[] = {0x9b, 0x32, 0x6b, 0x32, 0x6b, 0x45, 0x9b, 0x9b, 0x000013, 0x000013};
static char *emmc_prod_name[] = {"Y2P032", "MMC32G", "MMC32G", "MMC64G", "MMC64G", "DA4032", "Y2P128", "Y2P064", "G2M211", "G2M212"};
#endif
