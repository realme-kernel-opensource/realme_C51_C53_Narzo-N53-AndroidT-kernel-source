...
static int reflash_init(struct ovt_tcm_hcd *tcm_hcd)
{
	int retval = 0;
	int idx;
	...
	reflash_hcd->workqueue =
			create_singlethread_workqueue("ovt_tcm_reflash");
...
static int reflash_remove(struct ovt_tcm_hcd *tcm_hcd)
{
	int idx;
...
static int reflash_reinit(struct ovt_tcm_hcd *tcm_hcd)
{
	int retval;
...
static struct ovt_tcm_module_cb reflash_module = {
	.type = TCM_REFLASH,
	.init = reflash_init,
