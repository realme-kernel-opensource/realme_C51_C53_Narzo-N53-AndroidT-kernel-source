...
/*
 * For high resolution
 * When set FTS_HI_RES_EN to 1, the dts properity of "focaltech,display-coords"
 * should be changed
 * FTS_HI_RES_X, a multiple relative to the original resolution
 * FTS_HI_RES_X_MAX, const value, can't be modified
 */
#define FTS_HI_RES_EN                       0
#define FTS_HI_RES_X                        16
