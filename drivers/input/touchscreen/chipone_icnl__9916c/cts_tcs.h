...
int cts_tcs_polling_data(const struct cts_device *cts_dev,u8 *buf, size_t size);
...
enum TcsCmdIndex {
    ...
    TP_STD_CMD_SYS_STS_HI_SENSE_EN_RW,
	...
	TP_STD_CMD_GSTR_RAW_DBG_MODE_RW,
    TP_STD_CMD_GSTR_ENTER_MAP_RW,
	TP_STD_CMD_GSTR_DBG_EN_RW,
 ...
 */
    ...
    { 0, 1, 37, 1, 0, 1 },    /* TP_STD_CMD_TP_DATA_HEART_RO */
    ...
    { 0, 2, 26, 1, 1, 0 },      /* TP_STD_CMD_SYS_STS_HI_SENSE_EN_RW */
    ...
    { 0, 3, 32, 1, 1, 0 },    /* TP_STD_CMD_GSTR_RAW_DBG_MODE_RW */
    { 0, 3, 40, 1, 1, 0 },    /* TP_STD_CMD_GSTR_ENTER_MAP_RW */
    { 0, 3, 43, 1, 1, 0 },    /* TP_STD_CMD_GSTR_DBG_EN_RW */
    ...
    { 0, 9, 75, 1, 1, 0 },  /* TP_STD_CMD_PARA_KUNCKLE_RW, */
