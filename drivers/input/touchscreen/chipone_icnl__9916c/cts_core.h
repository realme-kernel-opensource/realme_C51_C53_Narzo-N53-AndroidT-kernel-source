...
union cts_firmware_status {
    ...
    struct {
        ...
        u8 high_temperature : 1;
        u8 low_temperature : 1;
        u8 bend_mode : 1;
        u8 palm_status : 1;
        u8 noise_mode : 1;
        u8 base_trace : 1;
...
struct cts_touch_debug_msg {
    ...
    u32 reset_flag;
    u16 frame_index;
    union cts_firmware_status fw_status;
...
extern int g_firmware_version_cts;
...
extern void set_tp_earjack_state( int attached);
extern void set_cts_tp_charger_mode( int attached);