...
#define CFG_CTS_DRIVER_VERSION              "v3.3.6"
...
#define CFG_CTS_FIRMWARE_FILENAME_INX           "chipone_firmware_inx.bin"
#define CFG_CTS_FIRMWARE_FILEPATH_INX           "/vendor/firmware/chipone_firmware_inx.bin"
...
/* Blackscreen test, test items:(active/idle)rawdata, noise */
#define CONFIG_CTS_BLACKSCREEN_TEST
