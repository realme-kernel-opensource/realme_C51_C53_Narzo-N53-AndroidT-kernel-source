...
{
	private_ts->chip_max_dsram_size = 49152;
...
static bool hx83108a_read_event_stack(uint8_t *buf, uint32_t length)
{
...
{
	g_core_fp.fp_read_event_stack = hx83108a_read_event_stack;
#if defined(HX_ZERO_FLASH)
