...
#define ISP_LARGE_LTM_SUBIMG_NUM   4
...
struct isp_sw_context {
	...
	struct camera_queue ltmhist_result_queue;
	struct camera_queue ltmhist_out_queue;
	struct camera_queue ltmmap_result_queue;
