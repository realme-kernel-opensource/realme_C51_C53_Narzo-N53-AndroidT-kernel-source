...
enum isp_ltm_cfg_cmd {
	...
	ISP_LTM_CFG_SUB_IMG_NUM,
	ISP_LTM_CFG_SUB_IMG_IDX,
	ISP_LTM_CFG_CALC_MODE,
	ISP_LTM_CFG_CALC_MAP_BUF,
	ISP_LTM_CFG_MAX,
};
...
struct isp_ltm_core_ops {
	...
	int (*pipe_proc)(void *handle, void *param, void *param1);
};
...
struct isp_ltm_ctx_desc {
	...
	struct camera_frame *ltm_hist_frame;
	struct camera_buf ltm_map_buf;
