...
struct nonzsl_xtm_hist_info {
	uint32_t use_for_xtm_hist;
	uint32_t large_size_x;
	uint32_t large_size_y;
	uint32_t cur_img_idx;
	uint32_t tile_x;
	uint32_t tile_y;
};
...
struct camera_frame {
	...
	struct nonzsl_xtm_hist_info nonzsl_xtm;
	...
	struct img_trim slice_out_trim;
